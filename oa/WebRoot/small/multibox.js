...
var multiBox = new Class({
	...
	initialize: function(className, options){
		...
		this.controlsContainer = new Element('div').addClass('none').inject(this.container);
	...
	createEmbedObject: function(){
		...
		if(this.type == 'quicktime'){
			...
			this.str += '<embed src="../../../web/js/'+this.contentObj.url+'" autoplay="true" pluginspage="http://www.apple.com/quicktime/download/" width="'+this.contentObj.width+'" height="'+this.contentObj.height+'"></embed>';
			this.str += '<object/>';
		...
		if(this.type == 'windowsMedia'){
			...
			this.str += '<embed type="application/x-mplayer2" src="../../../web/js/'+this.contentObj.url+'" Showcontrols="true" autoStart="true" width="'+this.contentObj.width+'" height="'+this.contentObj.height+'"></embed>';
			this.str += '<object/>';
		...
		if(this.type == 'real'){
			...
			this.str += ' width="'+this.contentObj.width+'" height="'+this.contentObj.height+'">';
			this.str += '<param name="src" value="../../../web/js/'+this.contentObj.url+'" />';
			this.str += '<param name="controls" value="ImageWindow" />';
			this.str += '<param name="autostart" value="true" />';
			this.str += '<embed src="../../../web/js/'+this.contentObj.url+'" controls="ImageWindow" autostart="true" width="'+this.contentObj.width+'" height="'+this.contentObj.height+'"></embed>';
			this.str += '<object/>';
