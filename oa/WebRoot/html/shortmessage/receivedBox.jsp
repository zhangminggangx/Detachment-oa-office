...
<html>
	<head>
		...
		<title>My JSP 'receivedBox.jsp' starting page</title>
				...
				.bind(
						...
						function() {
							...
							$("input[name='sendEmail']").val(
									$(this).parent().children("#sendEmailTd")
											.html());
													...
													handler : function() {
														...
														$
																.ajax( {
																	...
																	data : data,
																	success : function() {
																		window.location.href = "/oa/ViewReceivedMessageServlet";
																	},
																	dataType : 'json'
	...
	<body>
		<div>
			<pg:pager maxPageItems="10" maxIndexPages="4"
				url="/oa/ViewReceivedMessageServlet"
				export="currentNumber=pageNumber" index="center">
				<table width="100%" border="0" cellpadding="0" cellspacing="0"
					...
					<c:forEach items="${requestScope.receivedMessages}" var="item">
						<pg:item>
							<c:if test="${item.unread}">
								<tr class="Megtr">
									<td class="td07">
										<img src="/oa/images/sms_unReaded.png" alt="xx"/>
										<input type="checkbox" name="product" value="checkbox"/>
										</td>
							...
							<c:if test="${!(item.unread)}">
								<tr class="Megtr">
									<td class="td07">
										<img alt="xx" src="/oa/images/sms_readed.png" />
		...
		<div id="dlg" style="display: none">
			<table width="400" height="400" class="table01">
				...
				<tr>
					...
					<td class="td07">
						<textarea  rows="20" cols="50" name="contents" id="myEditRec"></textarea>
					</td>
				</tr>
			</table>
		</div>
