...
public class ViewUnApproveReportDetailServlet extends BaseServlet {

	/**
	 * Constructor of the object.
	 */
	public ViewUnApproveReportDetailServlet() {
		super();
	}
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		//得到物品
		List<Goods> goodsList=goodsServiceImpl.SearchViewGoodsInvName(travelApp.getAppId());
		//得到回赠礼品
		...
		//查询审核通过的出差申请
	     ...
	     Employee employee=employeeServiceImpl.SearchById(travelReport.getEmpId());
		...
		request.getRequestDispatcher("/html/worktime/daishenhe2.jsp").forward(request, response);
		}
	}
