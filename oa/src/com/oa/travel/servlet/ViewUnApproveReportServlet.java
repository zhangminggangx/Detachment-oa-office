...
public class ViewUnApproveReportServlet extends BaseServlet {

	/**
	 * Constructor of the object.
	 */
	public ViewUnApproveReportServlet() {
		super();
	}
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		List<WorkStream> workStreamsList=workStreamServiceImpl.findReportByBossId(empId, 100, pageNo);
		...
		int pageCount=workStreamServiceImpl.computePageCount(empId, 100, false,"BG");
		request.setAttribute("travelReportList", travelReportList);
		request.setAttribute("pageNo", pageNo);
		request.setAttribute("pageCount", pageCount);
		
		request.getRequestDispatcher("/html/worktime/d2.jsp").forward(request, response);
	}
