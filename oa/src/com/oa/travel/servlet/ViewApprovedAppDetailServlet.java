...
public class ViewApprovedAppDetailServlet extends BaseServlet {

	/**
	 * Constructor of the object.
	 */
	public ViewApprovedAppDetailServlet() {
		super();
	}
	...
	PresentServiceImpl presentServiceImpl = new PresentServiceImpl();
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		if (formNo.equals(null) || formNo == "") {
			...
			//得到结果审批
			List<ApproveResult> approveResult = approvedResultServiceImpl.findByFormNo(formNo);
			// 得到出差申请
			...
			// 得到回赠礼品
			List<Present> presentList = presentServiceImpl.SearchViewPresentInvName(appId);
			// 查询审核通过的出差申请
			List<TravelApp> appList = travelAppServiceImpl
					.searchByEmpIdAndState(empId, 4);
			int empId2=travelApp.getEmpId();
			Employee employee = employeeServiceImpl.SearchById(empId2);
			...
			request.getRequestDispatcher("/html/worktime/yishenhe1.jsp")
