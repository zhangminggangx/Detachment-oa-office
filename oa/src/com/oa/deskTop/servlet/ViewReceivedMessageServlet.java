...
public class ViewReceivedMessageServlet extends HttpServlet {

	/**
	 * Constructor of the object.
	 */
	public ViewReceivedMessageServlet() {
		super();
	}
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		request.getRequestDispatcher("/html/shortmessage/receivedBox.jsp").forward(
				request, response);
