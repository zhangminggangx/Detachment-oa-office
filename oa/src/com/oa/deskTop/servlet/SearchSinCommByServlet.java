...
public class SearchSinCommByServlet extends HttpServlet {

	/**
	 * Constructor of the object.
	 */
	public SearchSinCommByServlet() {
		super();
	}
	...
	private SinCommService sinsService =new SinCommServiceImpl();
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		List<SinComm> sinList=sinsService.searchAllSinComm(uId, typeId);
