...
public class FindUserEmailServlet extends HttpServlet {

	/**
	 * Constructor of the object.
	 */
	public FindUserEmailServlet() {
		super();
	}
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		List<String> emailList=shortmessageServiceImpl.findLike(likeStr);
		JSONArray jsonArray=JSONArray.fromObject(emailList);
